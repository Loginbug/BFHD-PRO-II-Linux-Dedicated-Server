...
wget -O BF2HD_PROII_Patch_G_linux_server_files.tar.gz.02 "https://github.com/Loginbug/BFHD-PRO-II-Linux-Dedicated-Server/raw/main/BF2HD_PROII_Patch_G_linux_server_files.tar.gz.02"
wget -O BF2HD_PROII_Patch_G_linux_server_files.tar.gz.03 "https://github.com/Loginbug/BFHD-PRO-II-Linux-Dedicated-Server/raw/main/BF2HD_PROII_Patch_G_linux_server_files.tar.gz.03"
